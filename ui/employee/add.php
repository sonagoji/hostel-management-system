...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>New Parent</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i> Parent Information
                </div>
                <!-- /.panel-heading -->
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Profession" class="form-control" name="empType" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
