        ...
        if (isset($_POST["btnSave"])) {
            ...
            if ($msg = "true") {
                ...
                if($result>=0)
                {
                    ...
                    //  $db->close();
                    echo '<script type="text/javascript"> alert("complaint Added Successfully.");window.location="pcomplaint.php";</script>';
                }
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="meal" action="pcomplaint.php"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
